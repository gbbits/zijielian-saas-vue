          ...
          >
            ...
            >
              <template v-slot:label>
                <div class="row items-center all-pointer-events">
                  ...
                  用户名
                  <q-tooltip class="bg-grey-8" anchor="top left" self="bottom left" :offset="[0, 8]">请输入用户名</q-tooltip>
                </div>
              </template>
            </q-input>
            ...
            >
              <template v-slot:default>
                我已阅读并同意 <router-link to="/" class="text-primary">链字节服务条款</router-link>
              </template>
            </q-checkbox>


            <div>
              <q-btn class="full-width" label="注册" color="primary" @click="submit"/>
            </div>
            <div>
              有账号?去 <router-link class="text-primary" to="/login">登录</router-link>
            </div>
          </q-form>
        </q-tab-panel>
        ...
        <q-tab-panel name="email">
          ...
          >
            ...
            >
              <template v-slot:label>
                <div class="row items-center all-pointer-events">
                  <q-icon class="q-mr-xs" color="primary" size="24px" name="fa-brands fa-adn" />
                  验证码
